...
export default async function BoogieMonsterPage() {
  const reader = getReader();
  const [artist, boogieMonster] = await Promise.all([
    reader.singletons.artist.read(),
    reader.singletons.boogieMonster.read(),
  ]);
  if (!artist || !boogieMonster) return null;
      ...
      <section className="relative py-24 md:py-36 overflow-hidden bg-black">
        ...
        <div className="container-lg relative z-10">
          ...
          <div className="flex gap-3 mt-6 flex-wrap">
            <span className="tag-gold">{boogieMonster.ikRole}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              ...
              <div className="card p-6">
                ...
                <p className="text-purple-400 text-sm mt-3">{boogieMonster.ikRole}</p>
